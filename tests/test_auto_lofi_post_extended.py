...
class TestLofiPostGeneratorExtended(unittest.TestCase):
    ...
    def test_extract_type_from_thumbnail_success(self, mock_pattern, mock_validate_config):
        """サムネイルからタイプ抽出成功時のテスト"""
        generator = LofiPostGenerator(self.args)
    ...
    def test_find_latest_file_not_found(self, mock_validate_config):
        ...
        with patch('auto_post.auto_lofi_post.Config.THUMBNAIL_PATTERN', "nonexistent_*.txt"):
