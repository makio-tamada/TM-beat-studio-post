...
class TestThumbnailSelection(unittest.TestCase):
    ...
    def test_thumbnail_selection_with_real_file(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            json.dumps({
                "type": "sad",
                "thumbnail_title": ["Sad Lo-Fi", "Melancholic Vibes"],
                "image_prompts": ["melancholic scene", "rainy window"],
            ...
            with patch('builtins.print') as mock_print:
                ...
                # ヘッダーが出力されることを確認
                header_found = any("=== thumbnail_title ランダム選択テスト ===" in call for call in print_calls)
    ...
    def test_thumbnail_selection_array_thumbnail_title(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            ...
            with patch('builtins.print') as mock_print:
                ...
                array_found = any("thumbnail_title (配列)" in call for call in print_calls)
                self.assertTrue(array_found)
                
                # ランダム選択テストが実行されることを確認
                random_test_found = any("ランダム選択テスト" in call for call in print_calls)
    ...
    def test_thumbnail_selection_string_thumbnail_title(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            ...
            with patch('builtins.print') as mock_print:
                ...
                string_found = any("thumbnail_title (文字列)" in call for call in print_calls)
    ...
    def test_thumbnail_selection_image_prompts_array(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            ...
            with patch('builtins.print') as mock_print:
                ...
                array_found = any("image_prompts (配列)" in call for call in print_calls)
                self.assertTrue(array_found)
    ...
    def test_thumbnail_selection_image_prompt_string(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            ...
            with patch('builtins.print') as mock_print:
                ...
                string_found = any("image_prompt (文字列)" in call for call in print_calls)
                self.assertTrue(string_found)
    ...
    def test_thumbnail_selection_empty_lines_handling(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join(mock_data_with_empty_lines))):
            with patch('builtins.print'):
                run_thumbnail_selection_test()
    ...
    def test_thumbnail_selection_random_choice_functionality(self):
        ...
        with patch('builtins.open', mock_open(read_data=''.join([
            ...
            with patch('auto_post.test_thumbnail_selection.random.choice') as mock_choice:
                ...
                with patch('builtins.print') as mock_print:
                    ...
                    selection_found = any("Test Selection" in call for call in print_calls)
