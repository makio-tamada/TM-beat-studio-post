...
def generate_image(prompt: str, output_dir: str = "src/test/output") -> str:
    ...
    image = pipe(
        prompt, guidance_scale=7.5, height=IMAGE_HEIGHT, width=IMAGE_WIDTH
    ).images[0]
...
def main():
    # テスト用のプロンプト
    test_prompt = (
        "lofi girl anime style, high school girl, study in the room, "
        "35mm film tone, 4k, realistic, high quality, 8k"
    )
